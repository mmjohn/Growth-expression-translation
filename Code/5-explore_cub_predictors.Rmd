...
fig_5d <- tibble(
  ...
  geom_line(data = gci_models, aes(x_g, g1), color = "#14505C", size = 1) +
  geom_line(data = gci_models, aes(x_g, g2), color = "#226B70", size = 1) +
  geom_line(data = gci_models, aes(x_g, g3), color = "#348781", size = 1) +
  geom_line(data = gci_models, aes(x_g, g0), color = "#4CA38F", size = 1) +
  geom_line(data = gci_models, aes(x_g, g_1), color = "#6BBE99", size = 1) +
  geom_line(data = gci_models, aes(x_g, g_2), color = "#9AD4A8", size = 1) +
  geom_line(data = gci_models, aes(x_g, g_3), color = "#C7E5BE", size = 1) +
  geom_richtext(
    data = r2_int_text,
...
# fig_5 <- ( fig_5a | fig_5b ) / (fig_5c | fig_5d) +
#   plot_annotation(
#      tag_levels = "A"
#    )
