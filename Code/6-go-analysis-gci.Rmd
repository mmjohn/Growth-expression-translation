...
# # essential gene data set from supp table 3
# #core_df3 - could add this in to distinguish essential in rich vs minimal environment - 'keio_supp_table_3.xls'
# core_df3 <- read_excel(
#   glue::glue(
#     {path_to_data}, 'ecoli_info/', 'keio_supp_table_3.xls'
#   ))
